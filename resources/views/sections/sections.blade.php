...
@section('content')
    ...
    @if (session()->has('delete'))
        <div id="alert-delete" class="alert alert-danger alert-dismissible fade show" role="alert">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                data-id="{{ $i->id }}" data-section_name="{{ $i->section_name }}"
    ...
    <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('sections.update', $i->id) }}" method="post" autocomplete="off">
                        @method('put')
                        @csrf
                        <div class="form-group">
    ...
    <div class="modal" id="modaldemo9">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <form action="{{ route('sections.destroy', $i->id) }}" method="post">
                    @method('delete')
                    @csrf
                    <div class="modal-body">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            setTimeout(() => {
                ...
                if (alertDelete) {
                    ...
                    alertDelete.classList.add('fade');
                    setTimeout(() => alertDelete.style.display = 'none', 500);
                }
