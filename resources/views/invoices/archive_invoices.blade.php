...
@section('content')
    ...
    @if (session()->has('restore_invoice'))
        <div id="alert-restore_invoice" class="alert alert-success alert-dismissible fade show" role="alert">
...
@section('js')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            setTimeout(() => {
                const alertAdd = document.getElementById('alert-restore_invoice');
